...
const STRINGS = {
  ...
  clientIdMissing: "client missing",
...
const secret = Buffer.from(getOption('secret', 'BEAT_STATS_SECRET'), 'base64');
const clientId = getOption('clientId', 'BEAT_STATS_CLIENT_ID');
